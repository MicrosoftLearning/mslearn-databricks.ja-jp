...
1. 既定のノートブック名 (**無題のノートブック *[日付]***) を `Data Ingestion and Exploration` に変更し、**[接続]** ドロップダウン リストで、**[サーバーレス]** コンピューティングがまだ選択されていない場合は選択します。 コンピューティングが実行されていない場合は、開始に 1 分ほどかかる場合があります。
